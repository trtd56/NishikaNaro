...
!pip install transformers unidic-lite fugashi ipadic python-Levenshtein
!pip install -U torch
...
"""|exp|CV|LB|memo|
|--|--|--|--|
|055|0.7665|0.7003|回帰loss0.5|
|056|0.7758||MLPをDropout, 微妙だったのでfold-2まで|
|057|0.7661|0.6948|URLを削除|
|058|0.7742||BERTのeval, 微妙だったのでfold-3まで|
|059|0.7613|0.6924|embed128+URL削除+domain|
|||||
|060|0.7600|0.6885|BERTのDropout=0.2|
|061|0.7614|0.6825|layer1|
|062|0.7607|0.6863|lr=3e-4|
|063|0.8391||lr=3e-5, fold-0のみ|
|064|0.7805||lr=1e-4, sigmoid, fold-0のみ(←はsoftmaxのスコア)|
|065|0.7615|0.6857|3epochでmlpをfreeze|
|066|0.7615|0.6832|BERTのDropout=0.4|
|067|0.7679|0.6921|kw50, 企画特徴|
|068|0.7686||kw norm, lr=3e-4, mlp init, fold-1まで|
|069|0.7699||lr=1e-3, fold-0まで|
|070|0.8512||r=3e-5, fold-0まで|
|071|0.8392||no freeze, fold-0まで|
|072|0.8565||lr=3e-5,BERT dropout fix, fold-0まで|
|072|0.7728||lr=3e-4,BERT dropout fix|
|073|0.7548|0.6998|mlp dropout|
|074|0.7623||dropout04|
|075|||layer2|
|076|0.7580|0.7004|no unfreeze|
|||||
|077|||ジャンルの累計特徴＋自動投稿か否か|
